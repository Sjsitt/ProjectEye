...
public class Figures2 : MonoBehaviour
{

    public static Figures2 Instance;
...
/*        Checkfigure();*/
    ...
    public void Pos1()
    {
        ...
        fig1.transform.position = new Vector3(15, 0, 0);

        fig11.transform.position = new Vector3(-15, 0, 0);
    ...
    public void Pos2()
    {
        ...
        fig2.transform.position = new Vector3(15, 0, 0);

        fig21.transform.position = new Vector3(-15, 0, 0);
    ...
    public void Pos3()
    {
        ...
        fig3.transform.position = new Vector3(15, 0, 0);

        fig31.transform.position = new Vector3(-15, 0, 0);
    ...
    public void Pos4()
    {
        ...
        fig4.transform.position = new Vector3(15, 0, 0);

        fig41.transform.position = new Vector3(-15, 0, 0);
    ...
    public void Pos5()
    {
        ...
        fig5.transform.position = new Vector3(15, 0, 0);

        fig51.transform.position = new Vector3(-15, 0, 0);
    ...
    public void Pos6()
    {
        ...
        fig6.transform.position = new Vector3(15, 0, 0);

        fig61.transform.position = new Vector3(-15, 0, 0);
    ...
    public void Pos7()
    {
        ...
        fig7.transform.position = new Vector3(15, 0, 0);

        fig71.transform.position = new Vector3(-15, 0, 0);
